...
install_dev_environment() {
    ...
    print_info "[2/7] Installing code-server..."
    ...
    print_info "[3/7] Enabling and starting code-server service..."
    ...
    print_info "[4/7] Creating code-server configuration..."
...
EOF
    ...
    print_info "[5/7] Restarting code-server service with new configuration..."
    ...
    print_info "[6/7] Checking code-server status..."
    systemctl status code-server@$USER --no-pager
    
    print_info "[7/7] Installing Tailscale..."
